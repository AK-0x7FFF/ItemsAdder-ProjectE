...
public class EMCManager {
    ...
    public BigInteger getItemEMC(ItemStack item) {
        Object obj = ExactItemWrapper.of(item);
        if (!(obj instanceof Material || obj instanceof ExactItemWrapper || obj instanceof IAItemWrapper))
            return BigInteger.ZERO;

        return this.plugin.getEmcBuilder().getEMC(obj);
    }
